...
_INSTALLER_FILES = {
    ...
    "apps/desktop/electron/update-preflight.test.ts",
    "apps/desktop/electron/update-preflight.ts",
    "apps/desktop/electron/windows-child-options.ts",
    "apps/desktop/electron/windows-elevated-force-release.test.ts",
    "apps/desktop/electron/windows-elevated-force-release.ts",
    "apps/desktop/electron/windows-process-terminate.test.ts",
