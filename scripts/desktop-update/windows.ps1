...
if (-not $SelfTestUi -and -not $SelfTestPipeDrain -and -not $SelfTestLog -and -not $SelfTestRelaunchCommand -and -not $SelfTestRelaunchEnvironment -and -not $SelfTestDirectRelaunch -and -not $SelfTestWorkingDirectory -and -not $InstallRoot) {
