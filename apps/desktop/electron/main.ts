...
import {
  ...
  jsonAgentFor,
  readJsonErrorBody,
  readApiJsonResponseWithByteLimit,  readStatusCode,
  withRetry
} from './api-transport'
...
import { branchTipApiUrl, cacheIsFresh, compareApiUrl, describeUpdateCheckFailure, githubRepoSlug, listLocalCommits, parseCompare, rateLimitFromHeaders, resolveBehindLocally } from './update-api-check'
...
import {
  ...
  resolveVenvPython,  scanVenvBlockers,
...
import { readWindowsHostPath, readWindowsUserEnvVar } from './windows-user-env'import { isPackagedInstallPath as isPackagedInstallPathUnderRoots } from './workspace-cwd'
