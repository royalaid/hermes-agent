...
export const ru = defineLocale({
  ...
  updates: {
    ...
    rebuildBody:
      'Код обновлён, но запущенное приложение собрано из более старой версии. Обновите сейчас, чтобы пересобрать его.',
    cancellingWait: 'Отмена…',
    cancelWaitFailed: 'Hermes не удалось отменить ожидание. Повторите попытку или закройте указанные процессы.',
    stages: {
      waiting: 'Ожидание завершения процессов',
      idle: 'Готовимся…',
      prepare: 'Готовимся…',
      fetch: 'Скачиваем…',
      pull: 'Почти готово…',
