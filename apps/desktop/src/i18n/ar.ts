...
export const ar = defineLocale({
  ...
  updates: {
    ...
    cancellingWait: 'جارٍ الإلغاء…',
    cancelWaitFailed: 'تعذّر على Hermes إلغاء الانتظار. حاول مرة أخرى أو أغلق العمليات المدرجة للمتابعة.',
    stages: {
      waiting: 'في انتظار إغلاق العمليات',
      idle: 'جار التحضير...',
      prepare: 'جار التحضير...',
      fetch: 'جار التنزيل...',
